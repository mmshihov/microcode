...
const CRegister *CFzusAlu3::Register(unsigned int index) const {
    switch (index) {
    case 1: return &mRg1;
    case 2: return &mRg2;
    case 3: return &mRg3;
...
const CCounter *CFzusAlu3::Counter(unsigned int index) const {
    switch (index) {
    case 1: return &mCt1;
    }
    return 0;
...
const CSummator *CFzusAlu3::Summator(unsigned int index) const {
    switch (index) {
    case 1: return &mSm1;
    }
    return 0;
...
const CXor *CFzusAlu3::Xor(unsigned int index) const {
    switch (index) {
    case 1: return &mXor1;
    }
    return 0;
...
CBitBlock CFzusAlu3::BusMaker(unsigned int index) const {
    switch (index) {
...
CBitBlock CFzusAlu3::DoDataOutput() const {
...
CBitBlock CFzusAlu3::DoControlOutput() const {
...
unsigned int CFzusAlu3::DoDataOutCount() const {
    return
...
CBitBlock CFzusAlu3::BusOut1() const {
    return mRg4.Output();
}

CBitBlock CFzusAlu3::BusOut2() const {
    return mRg3.Output().BitsAt(7,0);
}

void CFzusAlu3::ClearAllControls() {
...
unsigned int CFzusAlu3::Ct1Controls() const {
...
unsigned int CFzusAlu3::Rg1Controls() const {
    unsigned int controls = 0;
...
unsigned int CFzusAlu3::Rg2Controls() const {
    unsigned int controls = 0;
...
unsigned int CFzusAlu3::Rg3Controls() const {
    unsigned int controls = 0;
...
unsigned int CFzusAlu3::Rg4Controls() const {
    unsigned int controls = 0;
