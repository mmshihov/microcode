...
public:
    ...
    static const int Y_RG4_SHL       = 10;
    static const int Y_BD1_OUT       = 11;
    static const int Y_BD2_OUT       = 12;

    static const int Y_COUNT         = 13;
...
protected:
    ...
    virtual CFunctionalUnit* DoClone() const {return new CFzusAlu3(*this);}
